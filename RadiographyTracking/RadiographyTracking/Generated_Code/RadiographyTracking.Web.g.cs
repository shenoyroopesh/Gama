...
namespace RadiographyTracking.Web.Models
{
    ...
    public sealed partial class FinalRTReport : Entity
    {
        ...
        private string _totalFilmCount;
        ...
        partial void OnTotalFilmCountChanging(string value);
        partial void OnTotalFilmCountChanged();
        partial void OnViewingChanging(string value);
        ...
        public string Strength
        {
            ...
            set
            {
                if ((this._strength != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Strength");
                    this.ValidateProperty("Strength", value);
                    this._strength = value;
                    this.RaiseDataMemberChanged("Strength");
        ...
        /// <summary>
        /// Gets or sets the 'TotalFilmCount' value.
        /// </summary>
        // The following attributes were not generated:
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.NotMappedAttribute' is not visible in the client project 'RadiographyTracking'. Are you missing an assembly reference?
        ...
        public string TotalFilmCount
        {
            ...
            set
            {
                if ((this._totalFilmCount != value))
                {
                    this.OnTotalFilmCountChanging(value);
                    this.ValidateProperty("TotalFilmCount", value);
                    this._totalFilmCount = value;
                    this.RaisePropertyChanged("TotalFilmCount");
                    this.OnTotalFilmCountChanged();
                }
            }
        }
        
        /// <summary>
        /// Gets or sets the 'Viewing' value.
        /// </summary>
        // The following attributes were not generated:
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.NotMappedAttribute' is not visible in the client project 'RadiographyTracking'. Are you missing an assembly reference?
        ...
        public string Viewing
        {
            ...
            set
            {
                if ((this._viewing != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Viewing");
                    this.ValidateProperty("Viewing", value);
                    this._viewing = value;
                    this.RaiseDataMemberChanged("Viewing");
    ...
    public sealed partial class FinalRTReportRow : Entity
    {
        ...
        /// </summary>
        partial void OnCreated();
        partial void OnClassificationsChanging(string value);
        partial void OnClassificationsChanged();
        ...
        public string Classifications
        {
            ...
            set
            {
                if ((this._classifications != value))
                {
                    this.OnClassificationsChanging(value);
                    this.RaiseDataMemberChanging("Classifications");
                    this.ValidateProperty("Classifications", value);
                    this._classifications = value;
                    this.RaiseDataMemberChanged("Classifications");
                    this.OnClassificationsChanged();
                }
            }
        }
        ...
        public string Findings
        {
            ...
            set
            {
                if ((this._findings != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Findings");
                    this.ValidateProperty("Findings", value);
                    this._findings = value;
                    this.RaiseDataMemberChanged("Findings");
    ...
    public sealed partial class FixedPatternPerformanceRow : Entity
    {
        ...
        /// <summary>
        /// Gets or sets the 'Coverage' value.
        /// </summary>
        // The following attributes were not generated:
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.NotMappedAttribute' is not visible in the client project 'RadiographyTracking'. Are you missing an assembly reference?
        ...
        public string Coverage
        {
            ...
            set
            {
                if ((this._coverage != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Coverage");
                    this.ValidateProperty("Coverage", value);
                    this._coverage = value;
                    this.RaiseDataMemberChanged("Coverage");
...
namespace RadiographyTracking.Web.Services
{
    ...
    public sealed partial class RadiographyContext : DomainContext
    {
        ...
        /// <param name="like">The value for the 'like' parameter of the query.</param>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="FixedPatternPerformanceRow"/> entity instances.</returns>
        public EntityQuery<FixedPatternPerformanceRow> GetFixedPatternPerformanceReportQuery(string fpNo, bool like)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        /// </summary>
        /// <param name="RGReportId">The value for the 'RGReportId' parameter of the query.</param>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="RGReport"/> entity instances.</returns>
        public EntityQuery<RGReport> GetRGReportsQuery(int RGReportId)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("RGReportId", RGReportId);
        ...
        /// <param name="RGReportID">The value for the 'RGReportID' parameter of this action.</param>
        /// <param name="callback">Callback to invoke when the operation completes.</param>
        /// <param name="userState">Value to pass to the callback.  It can be <c>null</c>.</param>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public InvokeOperation<List<AddressStickerRow>> GetAddressStickers(string reportNo, int cellNo, int RGReportID, Action<InvokeOperation<List<AddressStickerRow>>> callback, object userState)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("reportNo", reportNo);
        ...
        /// <param name="RGReportID">The value for the 'RGReportID' parameter of this action.</param>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public InvokeOperation<List<AddressStickerRow>> GetAddressStickers(string reportNo, int cellNo, int RGReportID)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("reportNo", reportNo);
            parameters.Add("cellNo", cellNo);
        ...
        public interface IRadiographyServiceContract
        {
            ...
            IAsyncResult BeginGetAddressStickers(string reportNo, int cellNo, int RGReportID, AsyncCallback callback, object asyncState);
            ...
            /// <param name="like">The value for the 'like' parameter of this action.</param>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            ...
            [WebGet()]
            IAsyncResult BeginGetFixedPatternPerformanceReport(string fpNo, bool like, AsyncCallback callback, object asyncState);
            ...
            [WebGet()]
            IAsyncResult BeginGetRGReports(int RGReportId, AsyncCallback callback, object asyncState);
